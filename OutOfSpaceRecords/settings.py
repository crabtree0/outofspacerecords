"""
Django settings for OutOfSpaceRecords project.
...
SECRET_KEY = 'django-insecure-^gm6!vkbcv%54efi+q@ou-mg6ro9-wa&++@*xt$qwtfnp111jg'
...
ROOT_URLCONF = 'OutOfSpaceRecords.urls'
...
WSGI_APPLICATION = 'OutOfSpaceRecords.wsgi.application'
